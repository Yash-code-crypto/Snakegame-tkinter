...
class Snake(tk.Canvas):
    def __init__(self):
        ...
        self.score = 0
        if (not os.path.exists("./files/hiscore.txt")):
            with open("./files/hiscore.txt", "w") as f:
                f.write("0")

        with open("./files/hiscore.txt", "r") as f:
            self.hiscore = f.read()
    ...
    def create_objects(self):
        ...
        self.create_text(
            200, 12, text=f"hiscore: {self.hiscore}", tag="hiscore", fill="#fff", font=10
        )
    ...
    def check_food_collision(self):
        if self.snake_positions[0] == self.food_position:
            ...
            hiscore = self.find_withtag("hiscore")
            self.itemconfigure(hiscore, text=f"Hiscore: {self.hiscore}", tag="hiscore")
